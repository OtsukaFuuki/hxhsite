...
export const Quiz = ({ questions, onRestart }: QuizProps) => {
  ...
  return (
    <div className="px-2 py-3 border border-gray-300 rounded shadow-lg max-w-lg w-full bg-customHunter sm:max-w-2xl md:max-w-3xl">
      {finished ? (
        <div className="text-center flex flex-col items-center justify-center">
          ...
          <div className="mt-3 w-full max-h-[450px] overflow-y-auto bg-gray-900 p-4 rounded border border-gray-700 sm:max-h-[390px]">
