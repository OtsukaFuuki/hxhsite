export const quizData = [
  ...
  },
  {
    id: 8,
    question:
      'ハンター協会の最高責任者でもある、審査委員会の第12代会長といえば？(フルネームでも名前のみでも可)',
    correctAnswer: ['アイザック=ネテロ', 'ネテロ'],
    category: 'ハンター試験編',
...

  {
    ...
    correctAnswer: ['キル'],
    category: 'ククルーマウンテン編',
    image: '/images/Quiz/easy/22.jpg',
    level: 'easy',
  },
  {
    id: 23,
    question: 'クラピカの宿敵の幻影旅団の通り名といえば？',
    correctAnswer: ['蜘蛛', 'クモ', 'くも'],
    category: 'ヨークシンシティ編',
    image: '/images/Quiz/easy/23.jpg',
    level: 'easy',
  },
  {
    id: 24,
    ...
    correctAnswer: ['お菓子代', 'お菓子', 'おかし', '御菓子'],
    category: '天空闘技場編',
    image: '/images/Quiz/easy/24.jpg',
    level: 'easy',
  },
  {
    id: 27,
  ...
  {
    id: 30,
    question: 'ゴンたちの資金調達を手伝う内に仲良くなった元は贋作家といえば？',
    correctAnswer: ['ゼパイル'],
    category: 'ヨークシンシティ編',
    image: '/images/Quiz/easy/30.jpeg',
    level: 'easy',
  },
  {
    id: 33,
    ...
    correctAnswer: ['404'],
    category: 'ハンター試験編',
    // image: "/images/Quiz/easy/33.jpg", level: "easy",
  },
  {
    id: 41,
  ...
  {
    id: 46,
    question: 'ゴンが8歳の時に父親のジンのことを教えてくれた、ジンの後輩は？',
    correctAnswer: ['カイト'],
    category: 'ハンター試験編',
    image: '/images/Quiz/easy/46.jpg',
    level: 'easy',
  },
  {
    id: 52,
...

  {
    id: 67,
    question:
      '事実上クラピカにより倒された(自殺)、記憶を読み取る能力を持っている幻影旅団のメンバーの女性といえば？(カナ4文字)',
    correctAnswer: ['パクノダ'],
    category: 'ヨークシンシティ編',
    image: '/images/Quiz/easy/67.jpg',
    level: 'easy',
  },
  {
    id: 69,
  ...
  {
    id: 73,
    question: '政治的空白地でもある、なにを捨てても許される場所といえば何街？',
    correctAnswer: ['流星街'],
    category: 'ヨークシンシティ編',
  ...
  {
    id: 89,
    question: 'GI内の魔法都市といえば？',
    correctAnswer: ['マサドラ'],
    category: 'G・I編',
    image: '/images/Quiz/easy/89.jpg',
    level: 'easy',
  },
  {
    id: 92,
  ...
  {
    id: 103,
    question: '王(メルエム)の価値観を大きく変えた「軍儀」の世界王者といえば？',
    correctAnswer: ['コムギ'],
    category: 'キメラアント王誕生編',
    image: '/images/Quiz/easy/103.jpg',
    level: 'easy',
  },
  ...
  },
  {
    id: 117,
    question:
      '三回連続でお願いを叶えるとアルカが変化する姿のことを何と呼んでいるか？',
    correctAnswer: ['ナニカ'],
    category: '会長選挙編',
    image: '/images/Quiz/easy/117.jpg',
    level: 'easy',
  },
  {
    id: 119,
  ...
  {
    id: 11,
    question: 'ゴンの父親ジンと育ての親であるミトの関係性は？',
    correctAnswer: ['いとこ'],
    category: 'ハンター試験編',
    image: '/images/Quiz/easy/11.jpg',
    level: 'normal',
  },
  {
    id: 12,
  ...
  },
  {
    ...
    correctAnswer: ['クルト'],
    category: 'キメラアントNGL編',
    image: '/images/Quiz/easy/14.jpeg',
    level: 'normal',
  },
  {
    id: 15,
  ...
  },
  {
    ...
    correctAnswer: ['シャルナーク=リュウセイ', 'シャルナーク'],
    category: 'ヨークシンシティ編',
  ...
  {
    id: 78,
    question: 'クロロが陰獣の梟から盗んだ念能力といえば？',
    correctAnswer: ['不思議で便利な大風呂敷', 'ファンファンクロス'],
    category: 'ヨークシンシティ編',
    image: '/images/Quiz/easy/78.jpg',
    level: 'normal',
  },

  {
    id: 84,
    question: '第288期ハンター試験の合格者をすべて答えなさい。(名前のみでおk)',
    correctAnswer: ['キルア'],
    category: 'G・I編',
  ...
  {
    id: 101,
    question: 'ノヴが使用する念能力の名前は',
    correctAnswer: ['4次元マンション', 'ハイドアンドシーク'],
    category: 'キメラアントNGL編',
    image: '/images/Quiz/easy/101.jpg',
    level: 'normal',
  },
...

  {
    ...
    correctAnswer: ['11'],
    category: 'ハンター試験編',
    image: '/images/Quiz/easy/32.jpg',
    level: 'hard',
  },

  {
    id: 35,
    question: '四次試験でクラピカのターゲット(3点分)となった受験者の番号は？',
    correctAnswer: ['301'],
    category: 'ハンター試験編',
    image: '/images/Quiz/easy/35.jpg',
    level: 'hard',
  },
  {
    id: 36,
    question: 'ハンター試験会場へゴンが乗った船の名前といえば？',
    correctAnswer: ['クジラ号'],
    category: 'ハンター試験編',
    image: '/images/Quiz/easy/36.jpg',
    level: 'hard',
  },
  {
    id: 37,
    question: '試験会場は何市で行われたか？',
    correctAnswer: ['ザバン市'],
    category: 'ハンター試験編',
    image: '/images/Quiz/easy/37.jpg',
    level: 'hard',
  },
  {
    id: 38,
...

  {
    id: 43,
    question:
      '原作において二次試験の教官の男は豚の丸焼きを何頭食べたか？(数字のみ)',
    correctAnswer: ['70'],
    category: 'ハンター試験編',
    image: '/images/Quiz/easy/43.jpg',
    level: 'hard',
  },
  ...
  {
    id: 49,
    question: 'ヌメーレ湿原に突入した際の人数は？(数字のみ)',
    correctAnswer: ['311'],
    category: 'ハンター試験編',
    image: '/images/Quiz/easy/49.jpg',
    level: 'hard',
  },
  {
    id: 50,
  ...
  {
    id: 55,
    question: 'ククルーマウンテンの標高は何mか？(数字のみ)',
    correctAnswer: ['3722'],
    category: 'ククルーマウンテン編',
